...
const ProjectItem = ({ title, backgroundImg, tech, projectUrl }) => {
  ...
  return (
    <div
      ...
      className='project-card relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl group hover:bg-gradient-to-r from-[#5651e5] to-[#709dff] transition-colors duration-300'
    >
      ...
      <div className='hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
        ...
        <Link href={projectUrl}>
          <p className='text-center py-3 rounded-lg bg-white text-gray-700 font-bold text-lg cursor-pointer px-4'>More Info</p>
        </Link>
      </div>
    </div>
  );
